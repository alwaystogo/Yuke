...
- (void)createSubControllers{
    ...
    questionAndAnswerNav.tabBarItem.image = [[UIImage imageNamed:@"gongzuo"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    questionAndAnswerNav.tabBarItem.selectedImage = [[UIImage imageNamed:@"gongzuo1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    discoverNav.tabBarItem.image = [[UIImage imageNamed:@"text"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    discoverNav.tabBarItem.selectedImage = [[UIImage imageNamed:@"text1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    homePageNav.tabBarItem.selectedImage = [[UIImage imageNamed:@"home1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    yueNav.tabBarItem.selectedImage = [[UIImage imageNamed:@"camera1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    mineNav.tabBarItem.image = [[UIImage imageNamed:@"my"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    mineNav.tabBarItem.selectedImage = [[UIImage imageNamed:@"my1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
